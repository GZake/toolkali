...
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests survex-aven
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests yadm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests yadm*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *yadm*
...
#sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *wine*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-kde
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-mate
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-e17
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-gnome
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-lxde
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *win
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *win*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests win*
...
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-default
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-arm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-headless
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-nethunter
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-gpu
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-hardware
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-crypto-stego
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-fuzzing
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-802-11
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-bluetooth
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-rfid
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-sdr
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-voip
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-windows-resources
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-information-gathering
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-vulnerability
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-web
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-database
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-passwords
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-wireless
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-reverse-engineering
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-exploitation
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-social-engineering
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-sniffing-spoofing
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-post-exploitation
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-large
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-linux-everything
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-forensics
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-tools-reporting
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-live
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-xfce
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests nvidia*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests gdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests cinnamon
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests slim
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests lightdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests gnome
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests cdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests xdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests sddm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests lxdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests mdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests brzdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kde
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests plasma-framework
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kirigami
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests qingy
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests mlogind
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests tbsm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests wayland
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests xorg
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests weston
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kwin
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests openbox
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests mir
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests dwm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests wdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests nodm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests ldm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kdm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests greetd
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests dm
...
sudo apt --fix-broken install -y
sudo dpkg --configure -a
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-kde*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-mate*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-e17*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-gnome*
...
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kubuntu-desktop
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kubuntu-desktop*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *kubuntu-desktop*
...
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests i3wm*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *i3wm*
sudo apt-get -d --download-only -o dir::cache='/var/cache/apt/archives/'  -o APT::Default-Release=1  -o Debug::NoLocking=1 install -y i3wm*
sudo apt-get -d --download-only -o dir::cache='/var/cache/apt/archives/'  -o APT::Default-Release=1  -o Debug::NoLocking=1 install -y *i3wm*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests *i3wm*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-i3
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-i3-gaps
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests i3wm*
sudo apt-get -d --download-only -o dir::cache='/var/cache/apt/archives/'  -o APT::Default-Release=1  -o Debug::NoLocking=1 install -y kali-desktop-i3*
sudo apt-get -d --download-only -o dir::cache='/var/cache/apt/archives/'  -o APT::Default-Release=1  -o Debug::NoLocking=1 install -y kali-desktop-i3-gaps*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-i3*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests kali-desktop-i3-gaps*
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests i3wm
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests i3wm
