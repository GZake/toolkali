...
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests  linux-headers-$(uname -r)
...
sudo dpkg --add-architecture $(dpkg --print-architecture)
sudo dpkg --configure -a | tee -a  /root/Desktop/log.txt
sudo apt --fix-broken install -ym --ignore-hold | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
sudo apt update --fix-missing -ym --ignore-hold | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
sudo dpkg --configure -a | tee -a  /root/Desktop/log.txt
sudo apt --fix-broken install -ym --ignore-hold | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
sudo apt update --fix-missing -ym --ignore-hold | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
sudo apt-get update -ym --ignore-hold | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
...
key:
sudo apt-get  -o dir::cache='/var/cache/apt/archives/' -o Debug::NoLocking=1 -o APT::Default-Release=1 install -fym --ignore-hold --install-recommends --show-progress --install-suggests  launchpad-getkeys
...
sudo dpkg --remove-architecture tilegx
sudo dpkg --add-architecture $(dpkg --print-architecture)
sudo apt --fix-broken install -y | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
sudo apt update --fix-missing -y | grep "NO_PUBKEY" | awk '{ print $21 }' | xargs gpg | xargs apt-key add - | xargs addgpg-apt | awk '{ system("gpg "$21) }' | awk '{ print $21 }'| awk '{ print $21 }' | xargs apt-key adv | awk '{ system("apt-key add - "$21) }'
