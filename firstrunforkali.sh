...
[[ -f ~/toolkali/log/log_$(date "+%d_%h_%y").txt ]] || sudo touch ~/toolkali/log/log_$(date "+%d_%h_%y").txt
...
sudo apt-get install -o APT::Install-Recommends=1 -o APT::Install-Suggests=1 -fym --ignore-hold --install-recommends --allow-change-held-packages --show-progress --install-suggests  kde-standard
sudo apt-get install -o APT::Install-Recommends=1 -o APT::Install-Suggests=1 -fym --ignore-hold --install-recommends --allow-change-held-packages --show-progress --install-suggests  kde-full
...
echo "deb https://fast-cdn.meetsidekick.com/builds/ ./" | sudo tee /etc/apt/sources.list.d/sidekick.list
echo "deb https://sidekick-cdn-production.meetsidekick.com/builds/ ./" | sudo tee -a /etc/apt/sources.list.d/sidekick.list
...
sudo dpkg -i ~/toolkali/sidekick-linux-release*
