...
choose:
clear
sudo timedatectl set-timezone Asia/Ho_Chi_Minh >> $HOME/Desktop/log_$(date "+%d_%h_%y").txt
...
sudo dpkg-reconfigure libdvd-pkg | >>   $HOME/Desktop/log_$(date "+%d_%h_%y").txt
sudo dpkg --configure -a | >>   $HOME/Desktop/log_$(date "+%d_%h_%y").txt
sudo apt --fix-broken install -y | >>  $HOME/log_$(date "+%d_%h_%y" ).txt 
sudo dpkg --configure -a | >>   $HOME/Desktop/log_$(date "+%d_%h_%y").txt
sudo apt --fix-broken install -y | >>  $HOME/Desktop/log_$(date "+%d_%h_%y").txt
...
sudo chmod -Rv 777 /var/lib/apt/lists/*
sudo chown -Rv _apt:root /var/lib/apt/lists/*
sudo dpkg --configure -a | sudo tee -a $HOME/Desktop/log_$(date "+%d_%h_%y").txt
...
dpkg --configure -a | sudo tee -a $HOME/Desktop/log_$(date "+%d_%h_%y").txt
...
#######################need############################
need:
sudo bash ~/toolkali/need.sh | >> $HOME/Desktop/log_$(date "+%d_%h_%y").txt
if [ $choose1 -eq 6 ]
then
	goto uptab
fi
